...
INSERT INTO `beer` (`id`, `name`, `ABV`, `brewery`, `type`, `description`, `color`, `rating`, `food_pairing`, `image_url`, `availability`) VALUES (9, 'Dogfish Head Punkin Ale', 7.5, 'Dogfish Head', 'Punkin Ale', 'It features notes of pumpkin, brown sugar, cinnamon, and nutmeg, creating a profile reminiscent of pumpkin pie.', 'amber', 5, 'stews', NULL, 'seasonal');
